...
export type ParamsForPath<TPath extends PathSegment[]> = Simplify<ParamsFromSegments<TPath>> &
  Record<string, string>;

export type Handler<
  TPath extends PathSegment[] = any,
...
export type GenericHandler<TResponse extends z.ZodType | undefined = undefined> = Handler<
  any,
  z.ZodType,
  z.ZodType,
  TResponse
...
export type HandlerEntry = {
  handler: (req: Request<z.ZodType, z.ZodType, Record<string, string>>) => Promise<unknown>;
  body?: z.ZodType;
  query?: z.ZodType;
  response?: z.ZodType;
};
